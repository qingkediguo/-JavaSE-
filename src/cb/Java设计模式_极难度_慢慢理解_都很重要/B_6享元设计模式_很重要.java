...
享元模式（Flyweight）：
	...
	在某种程度上，你可以把单例看成是享元的一种特例。
	
	享元与单例的区别：
		1、与单例模式不同，享元模式是一个类可以有很多对象(共享一组对象集合)，而单例是一个类仅一个对象；
		2、它们的目的也不一样，享元模式是为了节约内存空间，提升程序性能(避免大量的new操作)，而单例模式则主要是共享单个对象的状态及特征。
*/
...
public class B_6享元设计模式_很重要 {
	public static void main(String[] args) {
		// 创建享元工厂
		享元工厂 factory = new 享元工厂();
		// 第一种情况：key相同时
