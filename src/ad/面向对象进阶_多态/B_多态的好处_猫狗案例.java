...
// 针对动物操作的工具类
class AnimalTool {
	private AnimalTool() {}			// 【这里是保证这个工具类不可能会被实例化，以前是讲过的】
	 ...
	 */
	public static void useAnimal(Animal a) {		// 【这里就用的多态的精髓部分，一定要深入理解】
													// 【这个就相当于Animal a = new 动物(); (方法是看右边的)】
		a.eat();
		a.sleep();
	}
