...
public class A_Map基础 {
	public static void main(String[] args) {
		...
		map.put("邓超", "孙俪");		// 【原教程有一个误解的地方：这里的前面是key,后面是values,这里的两个值不是等同的关系】
		map.put("黄晓明", "杨颖");
		map.put("周杰伦", "蔡依林");
		map.put("刘恺威", "杨幂");
		...
		// Set<K> keySet():获取集合中所有键的集合						// 【这个和下面的那个不要搞混了】
																// 【一个是返回的set,一个是返回的collection】
